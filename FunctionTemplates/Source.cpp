...
void main()
{
	...
	FillRand(d_arr, SIZE);
	Print(d_arr, SIZE);
	std::cout << "Сумма элементов массива:" << Sum(d_arr, SIZE) << endl;
	std::cout << "Среднее арифметическое элементов массива:" << Avg(d_arr, SIZE) << endl;
	std::cout << "Минимальное значение в массива:" << minValueIn(d_arr, SIZE) << endl;
	std::cout << "Максимальное значение в массива:" << maxValueIn(d_arr, SIZE) << endl;
	Sort(d_arr, SIZE);
	Print(d_arr, SIZE);
